...
import ru.mobile.mnp.ui.viewmodel.SettingsViewModel
...
class SettingsActivity : AppCompatActivity() {
    ...
    private lateinit var switchAutoUpdate: com.google.android.material.switchmaterial.SwitchMaterial
    ...
    private fun setupClickListeners() {
        ...
        btnUpdateNow.setOnClickListener {
            ...
            viewModel.triggerManualUpdate()
            Toast.makeText(this, "Starting manual update...", Toast.LENGTH_SHORT).show()
        }
    }
