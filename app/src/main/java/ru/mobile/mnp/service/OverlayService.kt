...
class OverlayService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // Use the timeout from preferences or default to 7 seconds
        val preferencesHelper = PreferencesHelper(this)
        val timeoutSeconds = intent?.getIntExtra("timeout", preferencesHelper.getOverlayTimeout())
        timeoutMillis = (timeoutSeconds ?: 7) * 1000L
